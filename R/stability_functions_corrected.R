...
#' @references
#' `r tools::toRd(bibentries[c("Lustgarten2009", "Bommert2017")])`
#' @encoding UTF-8
#' @md
#' @examples
...
#' @references
#' `r tools::toRd(bibentries[c("Somol2010", "Bommert2017")])`
#' @encoding UTF-8
#' @md
#' @examples
#' feats = list(1:3, 1:4, 1:5)
...
#' @references
#' `r tools::toRd(bibentries[c("Nogueira2016", "Bommert2017")])`
#' @encoding UTF-8
#' @md
#' @examples
#' feats = list(1:3, 1:4, 1:5)
...
#' @references
#' `r tools::toRd(bibentries[c("Wald2013")])`
#' @encoding UTF-8
#' @md
#' @examples
#' feats = list(1:3, 1:4, 1:5)
