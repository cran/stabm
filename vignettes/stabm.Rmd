...
Many stability measures have been proposed in the literature, see for example @bommert2017multicriteria, @bommert2020adjusted, and @nogueira2018quantifying for comparative studies.
...
- Adjusted: Does a measure consider similarities between features when evaluating the feature selection stability? Adjusted measures have been created based on traditional stability measures by including an adjustment term that takes into account feature similarities, see @bommert2020adjusted for details.
